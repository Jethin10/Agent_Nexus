        ...
        <div className="shell">
          <aside className="sidebar">
            ...
            <div className="sidebar-footer">
              <Link className="connection-health" href="/integrations"><i /><span>Manage connections</span></Link>
          ...
          <div className="app-frame">
            <header className="global-toolbar">
              ...
              <nav className="toolbar-actions" aria-label="Account shortcuts">
                <Link href="/?review=1" aria-label="Pending approvals"><svg viewBox="0 0 20 20" aria-hidden="true"><path d="M4 4h12v10H8l-4 3z" /></svg></Link>
                <Link href="/integrations" aria-label="Integration notifications"><svg viewBox="0 0 20 20" aria-hidden="true"><path d="M5 14h10l-1.5-2V8a3.5 3.5 0 0 0-7 0v4zM8.5 16.5h3" /></svg></Link>
                <span className="toolbar-avatar">A</span>
              </nav>
            </header>
